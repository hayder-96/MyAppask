...
public class DatabaseIslam extends SQLiteAssetHelper {

    private SQLiteDatabase sql;
    public static final String database = "islam.db";

    public static final String Table = "debt";
    ...
    public DatabaseIslam(Context context) {
        super(context, database, null, 1);

    }

    public ArrayList<Item> GetDataIslam() {
