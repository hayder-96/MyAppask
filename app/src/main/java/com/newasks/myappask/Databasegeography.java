...
public class Databasegeography extends SQLiteAssetHelper {


    private SQLiteDatabase sql;
    public static final String database = "geography.db";

    public static final String Table = "erath";
    ...
    public Databasegeography(Context context) {
        super(context, database, null, 1);

    }

    public ArrayList<Item> GetDatageography() {
