...
public class DatabaseActrs extends SQLiteAssetHelper {


    private SQLiteDatabase sql;
    public static final String database = "actrs.db";

    public static final String Table = "actr";
    ...
    public DatabaseActrs(Context context) {
        super(context, database, null, 1);

    }

    public ArrayList<Item> GetDataactr() {
